...
RUN sha256sum /shim-review/shimx64.efi /shim-16.0~rc1/shimx64.efi

RUN objdump -j .sbat -s /shim-review/shimx64.efi
RUN objdump -j .sbat -s /shim-16.0~rc1/shimx64.efi

RUN hexdump -Cv /shim-review/shimx64.efi > shim-review.hexdump
RUN hexdump -Cv /shim-16.0~rc1/shimx64.efi > shim-build.hexdump
